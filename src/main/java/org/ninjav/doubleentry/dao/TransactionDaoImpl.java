...
public class TransactionDaoImpl extends JdbcDaoSupport implements TransactionDao {
    ...
    public Set<String> getTransactionRefsForAccount(String accountRef) {
        ...
        List<String> transactionRefs = getJdbcTemplate().query(sql, dbUtil.stringRowMapper(), accountRef);
    ...
    private void storeTransactionLegs(List<TransactionLeg> legs, String clientRef, String transactionRef) {
        StringBuilder sql = new StringBuilder()
                ...
                .append("VALUES (?, ?, ?, ?, ?)");
        getJdbcTemplate().batchUpdate(sql.toString(), new TransactionLegBatchUpdater(legs, clientRef, transactionRef));
    }
    ...
    private static class TransactionLegBatchUpdater implements BatchPreparedStatementSetter {
        ...
        private TransactionLegBatchUpdater(List<TransactionLeg> legs, String clientRef, String transactionRef) {
